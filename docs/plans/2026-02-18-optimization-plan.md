...
**影响范围**:
- 修改文件: `config/flowgate.yaml`, `config/examples/*.yaml`
- 测试更新: 验证配置加载测试使用新格式
- 向后兼容: 仍保留兼容代码（本阶段不移除）
...
**v0.2.0** (短期，2-3 周):
- ✅ Phase 0: 准备阶段（回归测试、配置迁移、技术债更新）
- ✅ 拆分 cli.py 模块 (阶段 1.1)
- ✅ 统一异常处理 (阶段 1.2)
- ✅ 提取配置验证 (阶段 1.3)
- ✅ 简化路径解析 (阶段 2.1)
- ⚠️  添加 config migrate 命令 (阶段 2.2)
...
**下一步行动**:
1. ✅ 确认修订版计划
2. 🔄 开始执行 Phase 0.1: 补充回归测试
3. 🔜 Phase 0.2: 修复项目配置
4. 🔜 Phase 1.1: 拆分 cli.py（渐进式）

**详细执行计划**:
- Phase 0: 见 `docs/plans/2026-02-18-phase-0-preparation.md`
- Phase 1-5: 待创建详细执行计划
